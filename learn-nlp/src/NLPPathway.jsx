  ...
  return (
    <div>
      ...
      <div className="nlp-container">
        {/* N Nodes */}
        <div className="node main-node n1">1</div>
        <div className="node minor-node n2">1.1</div>
        <div className="node minor-node n3">1.2</div>
        <div className="node minor-node n4">1.3</div>
        <div className="letter n">N</div>
        
        {/* L Nodes */}
        <div className="node main-node l1">2</div>
        <div className="node minor-node l2">2.1</div>
        <div className="node minor-node l3">2.2</div>
        <div className="letter l">L</div>
        
        {/* P Nodes */}
        <div className="node main-node p1">3</div>
        <div className="node minor-node p2">3.1</div>
        <div className="node minor-node p3">3.2</div>
        <div className="node minor-node p4">3.3</div>
        <div className="letter p">P</div>
        
        {/* ! Nodes */}
        <div className="node main-node exclamation1">4</div>
        <div className="node minor-node exclamation2">4.1</div>
        <div className="node end-node exclamation3">4.2</div>
